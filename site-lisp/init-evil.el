...
;; (define-key evil-normal-state-map (kbd "C-q") 'one-key-menu-luolE-main)
;; (define-key evil-normal-state-map "\C-a" 'one-key-menu-luolE-main)
;; (define-key evil-motion-state-map "\M-m" 'one-key-menu-luolE-main)
